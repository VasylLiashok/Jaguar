(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".like__slider")) new core(".like__slider", {
                ...
                navigation: {
                    prevEl: ".like__control.swiper-button-prev",
                    nextEl: ".like__control.swiper-button-next"
                },
                on: {}
            });
        }
        ...
        intl_tel_input(phoneInputField, {
            preferredCountries: [ "ua", "us", "in", "de" ],
            initialCountry: "ua",
